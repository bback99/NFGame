...
//	theLog.Put(DEV_UK,"NGS_SockError, stat_size : ", lstStat.size(), " // Room_Size : ", lstRoom.size() );
...
//			theLog.Put(DEV_UK,"NGS_SockError,GameStat1 : ", sinfo.m_unitID.m_dwSSN, " ", sinfo.m_unitID.m_dwCategory, " ", sinfo.m_dwCU, " ", sinfo.m_dwSession, " ", sinfo.m_dwChannelCnt, " ", sinfo.m_dwRoomCnt, " ", sinfo.m_sOptionInfo);
...
//				theLog.Put(DEV_UK,"NGS_SockError,GameStat2 : ", sinfo2.m_unitID.m_dwSSN, " ", sinfo2.m_unitID.m_dwCategory, " ", sinfo2.m_dwCU, " ", sinfo2.m_dwSession, " ", sinfo2.m_dwChannelCnt, " ", sinfo2.m_dwRoomCnt, " ", sinfo2.m_sOptionInfo);
			}
		}
	}
